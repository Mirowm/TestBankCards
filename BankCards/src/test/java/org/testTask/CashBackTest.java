...
//Test1
        ...
        Assertions.assertEquals("500.00000",value1);
//Test2
        String value2 = cashBack.usePerk("13330.001");
        Assertions.assertEquals("666.50005", value2);
//Test3
        String value3 = cashBack.usePerk("4000.1212");
        Assertions.assertEquals("0", value3);
//Test4
        String value4 = cashBack.usePerk("33333.111111");
        Assertions.assertEquals("1666.65556", value4);
    }
}